$(function(){
    ...
    $('.products__slider').slick({
        slidesToShow: 4,
        slidesToScroll: 1,
        prevArrow: '<button class="products__slider__slider-btn products__slider__slider-btnprev"><img src="images/arrow-left_bl.svg" alt=""></button>',
        nextArrow: '<button class="products__slider__slider-btn products__slider__slider-btnnext"><img src="images/arrow-right_bl.svg" alt=""></button>',
        responsive: [
            {
                breakpoint: 1301,
                settings: {
    ...
    $(".menu__btn").on('click', function(){
        $('.menu-mobaile__list').toggleClass('menu-mobaile__list-active')
    });
